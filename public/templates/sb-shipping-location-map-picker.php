...
<div class="sb-hidden-fields-location">
    <input type="hidden" name="sbsl_location_map_default_lat" id="sbsl_location_map_default_lat" value="12.156010">
    <input type="hidden" name="sbsl_location_map_default_lng" id="sbsl_location_map_default_lng" value="-86.227220">
...
<div class="section sbsl-shipping-location-checkout">
    ...
    <a id="sbsl-show-map-picker-button" class="sb-button">Seleccionar ubicación</a>
    ...
    <div id="map-picker-container" class="map-picker-container">
        ...
        <div class="sbsl-location-address-container sbsl-input-group">
            <label for="<?php echo esc_attr('sbsl_location_new_address'); ?>" class="sbsl-input-label">
        ...
        <label id="sbsl-select-location-button" class="sb-button">Usar esta Dirección</label>
    </div>
</div>